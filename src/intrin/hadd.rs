...
mod tests {
    ...
    fn hadd_i8s() {
        ...
        assert_eq!(
            i8s::interleave(1, 2).hadd(i8s::interleave(3, 4)),
            i8s::interleave(3, 7)
        );
    }
    ...
    fn hadd_i16s() {
        ...
        assert_eq!(
            i16s::interleave(1, 2).hadd(i16s::interleave(3, 4)),
            i16s::interleave(3, 7)
        );
    }
    ...
    fn hadd_i32s() {
        ...
        assert_eq!(
            i32s::interleave(1, 2).hadd(i32s::interleave(3, 4)),
            i32s::interleave(3, 7)
        );
    }
    ...
    fn hadd_i64s() {
        ...
        assert_eq!(
            i64s::interleave(1, 2).hadd(i64s::interleave(3, 4)),
            i64s::interleave(3, 7)
        );
    }
    ...
    fn hadd_u8s() {
        ...
        assert_eq!(
            u8s::interleave(1, 2).hadd(u8s::interleave(3, 4)),
            u8s::interleave(3, 7)
        );
    }
    ...
    fn hadd_u16s() {
        ...
        assert_eq!(
            u16s::interleave(1, 2).hadd(u16s::interleave(3, 4)),
            u16s::interleave(3, 7)
        );
    }
    ...
    fn hadd_u32s() {
        ...
        assert_eq!(
            u32s::interleave(1, 2).hadd(u32s::interleave(3, 4)),
            u32s::interleave(3, 7)
        );
    }
    ...
    fn hadd_u64s() {
        ...
        assert_eq!(
            u64s::interleave(1, 2).hadd(u64s::interleave(3, 4)),
            u64s::interleave(3, 7)
        );
    }
    ...
    fn hadd_f32s() {
        ...
        assert_eq!(
            f32s::interleave(1.0, 2.0).hadd(f32s::interleave(3.0, 4.0)),
            f32s::interleave(3.0, 7.0)
        );
    }
    ...
    fn hadd_f64s() {
        ...
        assert_eq!(
            f64s::interleave(1.0, 2.0).hadd(f64s::interleave(3.0, 4.0)),
            f64s::interleave(3.0, 7.0)
        );
    }
}
