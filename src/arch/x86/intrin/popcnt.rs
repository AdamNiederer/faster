...
unsafe fn popcnt128(v: u8x16) -> usize {
    fallback!();
    v.be_u64s()
        .scalar_reduce(0, |acc, s| acc + (s.count_ones() as usize))
}
...
mod tests {
    ...
    test_popcnt!(
        (
            ...
            u64, u64, u64, i64, i64, i64
        ),
        (
            u8x64, u8x32, u8x16, i8x64, i8x32, i8x16, u16x32, u16x16, u16x8, i16x32, i16x16, i16x8,
            u32x16, u32x8, u32x4, i32x16, i32x8, i32x4, u64x8, u64x4, u64x2, i64x8, i64x4, i64x2
        ),
        (
            popcnt_u8x64,
            popcnt_u8x32,
