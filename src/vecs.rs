...
impl_packed! {
    u16, u16s, u16x16, 2, 16, ["avx"], ["avx512"],
...
impl_packed! {
    i16, i16s, i16x16, 2, 16, ["avx"], ["avx512"],
...
mod tests {
    ...
    macro_rules! test_sum {
        (($($el:tt),*), ($($vec:tt),*), ($($fn:tt),*), ($($sum:tt),*)) => (
            $(
                #[test]
                fn $fn() {
                    assert_eq!($vec::splat(1i8 as $el).sum(), $sum as $el);
                }
            )*
        )
    }
    ...
    test_sum!((u8, u8, u8, i8, i8, i8, u16, u16, u16, i16, i16, i16, u32, u32, u32, i32, i32, i32, f32, f32, f32, u64, u64, u64, i64, i64, i64, f64, f64, f64),
              ...
              (scalar_sum_u8x64, scalar_sum_u8x32, scalar_sum_u8x16, scalar_sum_i8x64, scalar_sum_i8x32, scalar_sum_i8x16, scalar_sum_u16x32, scalar_sum_u16x16, scalar_sum_u16x8, scalar_sum_i16x32, scalar_sum_i16x16, scalar_sum_i16x8, scalar_sum_u32x16, scalar_sum_u32x8, scalar_sum_u32x4, scalar_sum_i32x16, scalar_sum_i32x8, scalar_sum_i32x4, scalar_sum_f32x16, scalar_sum_f32x8, scalar_sum_f32x4, scalar_sum_u64x8, scalar_sum_u64x4, scalar_sum_u64x2, scalar_sum_i64x8, scalar_sum_i64x4, scalar_sum_i64x2, scalar_sum_f64x8, scalar_sum_f64x4, scalar_sum_f64x2),
              (64, 32, 16, 64, 32, 16, 32, 16, 8, 32, 16, 8, 16, 8, 4, 16, 8, 4, 16, 8, 4, 8, 4, 2, 8, 4, 2, 8, 4, 2));
